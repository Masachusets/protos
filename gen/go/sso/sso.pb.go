...
func (x *LoginReaponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LoginReaponse) ProtoMessage() {}

func (x *LoginReaponse) ProtoReflect() protoreflect.Message {
	mi := &file_sso_sso_proto_msgTypes[3]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use LoginReaponse.ProtoReflect.Descriptor instead.
func (*LoginReaponse) Descriptor() ([]byte, []int) {
	return file_sso_sso_proto_rawDescGZIP(), []int{3}
}

func (x *LoginReaponse) GetToken() string {
	if x != nil {
		return x.Token
	}
	return ""
...
const file_sso_sso_proto_rawDesc = "" +
	...
	"\x05Login\x12\x12.auth.LoginRequest\x1a\x13.auth.LoginReaponse\x126\n" +
	"\aIsSdmin\x12\x14.auth.IsAdminRequest\x1a\x15.auth.IsAdminResponseB\x17Z\x15pavlenko.sso.v1;ssov1b\x06proto3"
...
var file_sso_sso_proto_goTypes = []any{
	...
	(*LoginReaponse)(nil),    // 3: auth.LoginReaponse
...
var file_sso_sso_proto_depIdxs = []int32{
	...
	4, // 2: auth.Auth.IsSdmin:input_type -> auth.IsAdminRequest
	1, // 3: auth.Auth.Register:output_type -> auth.RegisterResponse
	3, // 4: auth.Auth.Login:output_type -> auth.LoginReaponse
	5, // 5: auth.Auth.IsSdmin:output_type -> auth.IsAdminResponse
